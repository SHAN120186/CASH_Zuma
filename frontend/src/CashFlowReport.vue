...
<template>
 <div class="card tools">
  <div class="tl-row">
   ...
   <div class="grow"><a class="button secondary tiny" :href="exportUrl('xlsx')"><AppIcon name="download"/> Excel</a><a class="button secondary tiny" :href="exportUrl('pdf')"><AppIcon name="file"/> PDF</a><button v-if="canPlan" class="tiny" @click="edit">Задать план</button></div>
  </div>
  <div class="tl-row">
